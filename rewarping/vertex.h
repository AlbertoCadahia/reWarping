...
Q_DECL_CONSTEXPR inline Vertex::Vertex(const QVector3D &position, const QVector3D &color, const QVector2D &texCoord) : m_position(position), m_color(color), m_texCoord(texCoord) {}
